...
function Display(canvas, buffer_w = 1920, buffer_h = 1080) {
    ...
    // Using  a map for the display stack cause they are keyed and can be iterated in the order of insertion. If a more sophisticated system is needed (like changing childs order on runtime) a support array for the rendering ordermay be needed or perhaps a map rearranging utility
